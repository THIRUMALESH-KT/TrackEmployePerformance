...
public class EmployeeDataService {
	...
	public List<EmployeeData> getLessThanMinReaingEmployeeDataBasedOnDesig() {
		...
		List<EmployeeData> LessPerformanceCandidates=employeeDataRepository.findByEmpSkillsDesignationAndEmpRatingTechnicalLessThanAndEmpRatingStartDate(designation, 2.50, startDate);
    ...
    public void sendMail() throws MessagingException {
    	...
    	for(EmployeeData employee:employeeDeta) {
    		String Email=employee.getEmpEmail();
    	     ...
    	     //for checking purpose create MailHistroy entity and set data with this month date
    		MailHistory historyy=mailHistoryRepository.findByEmpMailAndSentDateAfterOrSentDateEquals(employee.getEmpEmail(), firstDayOfCurrentMonth,firstDayOfCurrentMonth);
	...
	public EmployeeData inserEmployee(EmployeeDataUserRequest request) throws Exception {
		...
		EmployeeProfile empProfile=setSkills(employeeDataRepository.save(employeeData).getEmployeeId(),request.getEmpSkills());
